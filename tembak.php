...
echo color("red","| github: renaldimanurung |\n");
echo color("red","| fanspage : renaldimanurung34|\n");
...
// function change(){
        ...
        sleep(3);
        $goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAINGORIDE"}');
